...
class AP:
    ...
    def __call__(self, metadata, proposals_dict: dict) -> dict:
        ...
        for iou_threshold in self.iou_thresholds:
            ...
            for meta in metadata:
                proposals = torch.tensor(proposals_dict[meta.split(',')[1]])

                index = meta.find('[')
                sliced = meta[index:]

                fake_periods = eval(sliced)
